...
int traite_message(char *message, struct pollfd, Parametre parametres, char ***matrice, User *user, int);
void reception_message(struct pollfd *poll_message, int *nbClient, User **liste, Parametre parametres, char ***matrice);
int check_limite(User *user, Parametre parametres, char ***matrice, char **position, char *color, int);
