...
void traite_message(char *message, struct pollfd, char ***matrice, Parametre);
void reception_message(struct pollfd *poll_message, int *nbClient, User **liste, char ***matrice, Parametre);
